/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b5031a5a5f2b01344a56f805f1175854)
...
interface __BaseEnv_Env {
	...
	SECRET_KEY: string;
	TALKTOSTAFF_CHANNEL: string;
	TALKTOSTAFF_GROUPS: string;
	TALKTOSTAFF_MUTE_ROLE: string;
	VERIFY_GUILD: string;
	VERIFY_ROLE: string;
	VERIFY_USERNAME_CHANNEL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_INVITE" | "APP_ID" | "BOT_PUBLIC_KEY" | "BOT_TOKEN" | "NOTIFICATION_CHANNEL" | "OAUTH_CLIENT_ID" | "OAUTH_CLIENT_SECRET" | "SECRET_KEY" | "TALKTOSTAFF_CHANNEL" | "TALKTOSTAFF_GROUPS" | "TALKTOSTAFF_MUTE_ROLE" | "VERIFY_GUILD" | "VERIFY_ROLE" | "VERIFY_USERNAME_CHANNEL" | "WIKI_REST_API" | "ZEPTOMAIL_AUTH">> {}
}
